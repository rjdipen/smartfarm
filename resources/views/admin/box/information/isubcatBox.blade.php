    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('Information\IsubcatController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="input-group">
                            <span class="input-group-addon">Category</span>
                            <select class="form-control m-input" name="icatID" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="name" placeholder="SubCategory Name" type="text" required>
                            </div>
                        </div><br>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('Information\IsubcatController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
